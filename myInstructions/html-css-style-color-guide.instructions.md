...
- Highly saturated hot colors on large surfaces
- Neon-like backgrounds that reduce readability
- Backgrounds that lower text contrast below accessibility targets
...
- Text colors with weak contrast to their background
- Extremely saturated text colors for long reading passages
...
- Neon and aggressively saturated colors in content-heavy areas
- Highly saturated hot colors
- Colors with low contrast ratios (fails WCAG accessibility standards)

### Theme Compatibility

- Do not hard-ban specific hues globally; allow theme-defined palettes.
- Evaluate colors in context of contrast, readability, and brand direction.
- Ensure both light and dark themes maintain accessible contrast.
